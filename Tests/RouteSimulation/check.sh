...
PY
xcrun swiftc "$QA_DIR/Models.swift" Geranium/LocSim/CoordTransform.swift Geranium/LocSim/RouteFinish.swift Tests/RouteSimulation/main.swift -o "$QA_DIR/model-tests"
"$QA_DIR/model-tests"
xcrun swiftc "$QA_DIR/Models.swift" Geranium/LocSim/CoordTransform.swift Geranium/LocSim/RouteFinish.swift Tests/RouteSimulation/LiveCycling.swift -o "$QA_DIR/cycling-tests"
