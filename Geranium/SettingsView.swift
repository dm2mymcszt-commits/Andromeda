            ...
            Form {
                ...
                Section("About") {
                    ...
                    Text("Based on Andromeda by son3ra1n and Geranium by c22dev. GPL-3.0.")
                        .font(.caption).foregroundColor(.secondary)
                    Text("Data sources: [Apple Maps](https://www.apple.com/maps/), [OpenStreetMap contributors](https://www.openstreetmap.org/copyright), [routing](https://routing.openstreetmap.de/about.html), [IGN](https://geoservices.ign.fr/services-geoplateforme-geocodage), [Open-Meteo](https://open-meteo.com/en/docs/elevation-api), [Copernicus](https://doi.org/10.5270/ESA-c5d3d65). [Open Location Code and licenses](https://github.com/dm2mymcszt-commits/Andromeda/blob/experiment/route-motion/THIRD-PARTY-NOTICES.md).")
                        .font(.caption).foregroundColor(.secondary)
                }
            }
